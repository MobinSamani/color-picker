import { openBlock as d, createElementBlock as a, renderSlot as g, createElementVNode as e, toDisplayString as p, normalizeStyle as u, withDirectives as f, Fragment as b, renderList as h, createCommentVNode as _, vModelText as x, vShow as y, resolveComponent as v, createVNode as w, createStaticVNode as k } from "vue";
const C = {
  props: ["modelValue"],
  computed: {
    model: {
    ...
    e("div", N, [
      e("div", A, [
        e("button", {
          ...
          style: u(`background-color: ${o.model}`),
          onClick: l[0] || (l[0] = (...t) => n.toggleShow && n.toggleShow(...t))
        }, [
          e("div", E, p(o.model), 1)
        ], 4),
        f(e("div", j, [
          s.colors && s.colors.length ? (d(), a("div", F, [
            (d(!0), a(b, null, h(s.colors, (t) => (d(), a("div", {
              key: t,
              class: "w-[33px] h-[33px] rounded-lg cursor-pointer",
              title: t,
              style: u(`background-color: ${t}`),
              onClick: (i) => n.setColor(t)
            }, null, 12, M))), 128))
          ])) : _("", !0),
          e("div", P, [
            z,
            f(e("input", {
              ...
              onChange: l[2] || (l[2] = (...t) => n.toggleShow && n.toggleShow(...t))
            }, null, 544), [
              [x, o.model]
            ])
          ])
...
}, U = { class: "min-h-screen bg-gray-100 flex items-center justify-center p-8" }, O = { class: "flex flex-col gap-y-8 w-full lg:w-1/2 xl:w-1/3 2xl:w-1/4" }, T = /* @__PURE__ */ e("div", { class: "flex items-center justify-center gap-2 flex-wrap text-center" }, [
